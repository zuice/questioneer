...
import { Grid, Header, Form, Input, Button, Segment } from 'semantic-ui-react';
...
const NewQuestion = () => {
  ...
  if (data && !error) {
    return (
      <Layout me={data && data.me} action="Create Question">
        <Grid>
          <Grid.Column mobile={16} tablet={16} computer={10}>
            <Header>
              <Header.Content>Create Question</Header.Content>
              <Header.Subheader>
                Create a question to get answered now!
              </Header.Subheader>
            </Header>
